...
sec_key2 = (
    "fib.pivot.alerts.test"  # Can be anything. Has to match with "key" in your TradingView alert message. lenh order trade
)
# Telegram Settings
send_telegram_alerts = True
tg_token = "5089014574:AAGa7J9DqvM7I0Rxt7t5grxtKzF0uTwq7xE"  # Bot token. Get it from @Botfather
channel_1 = -1001540271962 # Channel ID (ex. -1001487568087)
channel_2 = -1001620765727 # Channel ID (ex. -1001487568087)
